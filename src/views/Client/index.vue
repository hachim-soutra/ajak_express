...
import UserDelete from "@/components/popup/ClientDelete.vue";
import UserUpdate from "@/components/popup/ClientUpdate.vue";
import UserCreate from "@/components/popup/ClientCreate.vue";
import ApiService from "@/services/api.service";
import moment from "moment";

export default {
  mounted() {
    this.fetchData(`${this.$app_url}/api/auth/client`);
  },
  filter: {
    formatted(v) {
  ...
  methods: {
    ...
    onShowClick(item) {
      this.$router.push({ name: "Client.show", params: { id: item.id } });
    },
  },
};
</script>
