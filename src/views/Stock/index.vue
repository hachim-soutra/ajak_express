        ...
        <v-col>
          ...
          >
            <template v-slot:item="row">
              <tr>
                <td>{{ row.item.name }}</td>
                <td>{{ row.item.client_id }}</td>
                <td>{{ row.item.livreur_id }}</td>
                <td>{{ row.item.phone }}</td>
                <td>{{ row.item.date_livraison }}</td>
                <td>{{ row.item.date_arrive }}</td>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Date livraisent", value: "name", class: "black--text" },
        { text: "Date arrive", value: "name", class: "black--text" },
  ...
  methods: {
    ...
    onShowClick(item) {
      this.$router.push({ name: "Stock.show", params: { id: item.id } });
    },
  },
};
</script>
